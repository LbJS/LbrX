import { deleteLocalStorageMock, deleteMockedWindow, deleteReduxDevToolsExtensionMock, deleteSessionStorageMock, mockLocalStorage, mockReduxDevToolsExtension, mockSessionStorage, mockWindow } from 'mocks'
