...
describe('Helper Function - countObjectChanges():', () => {
  ...
  it.each`
    ...
    ${1.1}  | ${{ a: 'a', b: 'b' }}                                     | ${{ a: 'a', b: 'c' }}                                     | ${1}
    ${1.2}  | ${{ a: () => { }, b: null }}                              | ${{ a: false, b: () => { } }}                             | ${2}
    ${1.3}  | ${{ a: () => { } }}                                       | ${{ a: () => { } }}                                       | ${0}
    ${1.4}  | ${{ a: 'a', b: 'b', c: '3' }}                             | ${{ a: null, b: undefined, c: 3 }}                        | ${3}
    ${1.5}  | ${{ a: 0, b: 0, c: 0 }}                                   | ${{ a: null, b: undefined, c: '' }}                       | ${3}
    ${1.6}  | ${{ a: new Date(2000, 0, 1), b: new Date(2000, 0, 1) }}   | ${{ a: new Date(2000, 0, 1), b: null }}                   | ${1}
    ${1.7}  | ${{ a: null, b: new Date(2000, 0, 1) }}                   | ${{ a: new Date(2000, 0, 1), b: new Date(2000, 0, 2) }}   | ${2}
    ${1.8}  | ${{ a: undefined, b: new Date(2000, 0, 1) }}              | ${{ a: new Date(2000, 0, 1), b: undefined }}              | ${2}
    ${1.9}  | ${{ a: null, b: undefined }}                              | ${{ a: undefined, b: null }}                              | ${2}
    ${1.10} | ${{ a: {}, b: [] }}                                       | ${{ a: {}, b: [] }}                                       | ${0}
    ${1.11} | ${{ a: [], b: {} }}                                       | ${{ a: {}, b: [] }}                                       | ${2}
  ...
  it.each`
    ...
    ${2.2}  | ${[undefined]}                                            | ${[]}                                                     | ${1}
    ${2.3}  | ${[null]}                                                 | ${[]}                                                     | ${1}
    ${2.4}  | ${[null]}                                                 | ${[undefined]}                                            | ${1}
    ${2.5}  | ${[]}                                                     | ${[]}                                                     | ${0}
    ${2.6}  | ${[null, undefined, 0, '', false]}                        | ${[]}                                                     | ${5}
    ${2.7}  | ${[{ a: [] }, { a: [1] }]}                                | ${[{ a: [1] }, { a: [1] }]}                               | ${1}
    ${2.8}  | ${[{ a: [true] }, { a: [1] }]}                            | ${[{ a: [true] }, { a: [1] }]}                            | ${0}
    ${2.9}  | ${[{ a: [{}, [new Date(2000, 0)]] }]}                     | ${[{ a: [{}, [new Date(2000, 0)]] }]}                     | ${0}
  ...
  it.each`
    testId  | objA                                                      | objB                                                      | numOfDiffs
    ${3.1}  | ${{ a: { a: false } }}                                    | ${{ a: { a: false } }}                                    | ${0}
    ${3.2}  | ${{ a: { a: false } }}                                    | ${{ a: { a: true } }}                                     | ${1}
    ${3.3}  | ${{ a: { a: null } }}                                     | ${{ a: { a: undefined } }}                                | ${1}
    ${3.4}  | ${{ a: { a: null } }}                                     | ${{ a: { b: undefined } }}                                | ${2}
    ${3.5}  | ${{ a: { a: [null] } }}                                   | ${{ a: { a: [undefined] } }}                              | ${1}
    ${3.6}  | ${{ a: { b: new Date(2000, 0) } }}                        | ${{ a: { b: new Date(2000, 0) } }}                        | ${0}
    ${3.7}  | ${{ a: { b: new Date(2000, 0) } }}                        | ${{ a: { b: new Date(2000, 1) } }}                        | ${1}
    ${3.8}  | ${{ a: { b: () => { } } }}                                | ${{ a: { b: () => { } } }}                                | ${0}
    ${3.9}  | ${{ a: { b: () => { } } }}                                | ${{ a: { b: [] } }}                                       | ${1}
  ...
  it.each`
    testId | objA                                                        | objB                                                            | numOfDiffs
    ${4.1} | ${new TestSubject({})}                                      | ${new TestSubject({})}                                          | ${0}
    ${4.2} | ${new TestSubject({ getterSetterDate: new Date(1900, 0) })} | ${new TestSubject({ getterSetterDate: new Date(1900, 1) })}     | ${1}
    ${4.3} | ${instancedTestSubject}                                     | ${plainTestSubject}                                             | ${0}
  ...
  it.each`
    testId | objA                                                        | objB                                                            | numOfDiffs
    ${5.1} | ${{ a: moment(new Date(1900, 0)) }}                         | ${{ a: moment(new Date(1900, 0)) }}                             | ${0}
    ${5.2} | ${{ a: moment(new Date(1900, 0)) }}                         | ${{ a: moment(new Date(1900, 1)) }}                             | ${1}
    ${5.3} | ${{ a: moment(new Date(1900, 0)) }}                         | ${{ a: new Date(1900, 0) }}                                     | ${1}
